...
.scroller-left {
      ...
      <div class="navbar navbar-inverse navbar-fixed-top sticky" role="navigation">
         ...
         <div class="collapse navbar-collapse navbar-ex1-collapse">
            ...
            <div class="col-sm-3 col-md-3 pull-right">
               <form class="navbar-form" role="search" action="conferenceSearch.php" method="POST">
                  <div class="input-group">
                     <input type="text" class="form-control" placeholder="Search Conference" size="100" name="category">
  ...
  <div class="wrapper">
    <ul class="nav nav-tabs list" id="myTab">
      <li><a href="journalSearch.php">Journals</a></li>
      <li class="active"><a href="conferenceSearch.php">Conferences</a></li>
  </ul>
  </div>
</div>
  <?php
...
<div class="pull-left"><img src="branding elements\logo white.png" class="img-circle" width="60px" height="60px"></div>
               ...
               <div class="tab-content" style="padding-top: 10px">
                  <div role="tabpanel" class="tab-pane active" id="personal">
                     ...
                     <div id="content1" class="collapse" align="justify">
                          Domains: <?php echo $result['Domains']; ?><br>
                          Subdomains: <?php echo $result['Sub domains']; ?><br>
                          Journals: <?php echo $result['Journal']; ?><br>
                          Submission deadline: <?php echo $result['Submission deadline']; ?><br>
                          Fee: <?php echo $result['Fee']; ?><br>
                          Agenda: <?php echo $result['Agenda']; ?><br> 
                          Discussion: <?php echo $result['Discussion']; ?>
                     </div>
                  </div>
               </div>
            </div>
